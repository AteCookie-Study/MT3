...
Vector3 F2VMultiply(float scalar, const Vector3& v) {
	Vector3 result;
...
Matrix4x4 MakeRotateXYZMatrix(const Vector3& rotate) {
	...
	// ŒvŽZˆ—
	result = MultiplyMatrix(tempXMatrix, MultiplyMatrix(tempYMatrix, tempZMatrix));
...
Vector3 Project(const Vector3& v1, const Vector3& v2) {
	...
	result = Multiply(Multiply(v1, v2), v2);
